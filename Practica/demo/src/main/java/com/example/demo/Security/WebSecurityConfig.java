    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/products/*").hasRole("USER")
                        .requestMatchers(HttpMethod.POST,"/api/products/filter").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/product/new").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST,"/api/product/*/upload").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/api/product/*/modify").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/api/product/*/upload").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/product/*/addToCart").hasRole("USER")
                        .requestMatchers(HttpMethod.GET,"/api/cart").hasRole("USER")
                        .requestMatchers(HttpMethod.POST,"/api/cart/checkout").hasRole("USER")
                        .requestMatchers(HttpMethod.POST,"/api/product/*/removeFromCart").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/users/{id}/reviews").hasRole("USER")
                        .requestMatchers(HttpMethod.GET,"/api/users/{id}/purchases").hasRole("USER")
